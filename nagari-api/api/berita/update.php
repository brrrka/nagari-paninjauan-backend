...
if (
    ...
    if ($berita->update()) {
        ...
        echo json_encode(array("message" => "Berita was updated successfully."));
    } else {
        http_response_code(503);
        echo json_encode(array("message" => "Unable to update berita."));
    }
} else {
    http_response_code(400);
    echo json_encode(array("message" => "Unable to update berita. Data is incomplete."));
}
